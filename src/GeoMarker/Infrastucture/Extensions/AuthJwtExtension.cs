...
namespace GeoMarker.Infrastucture.Exceptions.Demo_Jwt;
        ...
        .AddJwtBearer(options =>
        {
            ...
            options.Events = new JwtBearerEvents()
            {
                ...
                OnMessageReceived = context =>
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(token) &&
                        new JwtSecurityTokenHandler().ReadJwtToken(token)?.Claims?.FirstOrDefault(x => x.Type ==JwtConfig.Forever) != null)
